...
import android.Manifest;import android.app.*;import android.content.pm.PackageManager;import android.graphics.Color;import android.os.Bundle;import android.webkit.*;
public class MainActivity extends Activity {
 ...
 @Override public void onCreate(Bundle b){super.onCreate(b);getWindow().setStatusBarColor(Color.rgb(9,10,15));getWindow().setNavigationBarColor(Color.rgb(9,10,15));
  ...
  w=new WebView(this);WebSettings s=w.getSettings();s.setJavaScriptEnabled(true);s.setDomStorageEnabled(true);w.setBackgroundColor(Color.rgb(9,10,15));w.setWebViewClient(new WebViewClient());w.addJavascriptInterface(new Bridge(),"LunarAndroid");setContentView(w);w.loadUrl("file:///android_asset/index.html");}
